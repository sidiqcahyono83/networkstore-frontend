...
export const Navbar = () => {
  ...
  return (
    <div className="max-w-screen-2xl bg-slate-700 mx-auto justify-center">
      <nav className="bg-gray-700 p-4 flex mx-auto justify-between items-center">
        <div className="flex items-center">
          ...
          <div
            ...
            } absolute top-16 left-0 w-full bg-gray-700 md:flex md:relative md:top-0 md:w-auto md:ml-4`}
          >
