  ...
  return (
    <div className="my-6 mx-6">
      ...
      <form onSubmit={handleFilter}>
        <div className="flex grid-cols-3 items-center gap-4 ">
          <div className="mb-4">
            ...
            <select
              ...
              className="mt-1 block w-56 border border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
            >
