      ...
      <div className="max-w-full mx-auto items-center h-[1203px]">
        ...
        <div className="flex items-center justify-center space-x-2 my-6 mx4">
          <Card href="#" className="w-[303px] h-[404px] bg-transparent">
            <div>
              <img src="../../public/CCR3.png" alt="" sizes="6" srcset="" />
            </div>
        ...
        <div className="flex items-center justify-center space-x-2 my-6 mx4">
          <Card href="#" className="w-[303px] h-[404px] bg-transparent">
            <div>
              <img src="../../public/4011.png" alt="" sizes="6" srcset="" />
            </div>
            <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              RB4011iGS+RM
            </h5>
            <p className="font-normal text-gray-700 dark:text-gray-400">
              10xGigabit port router with a Quad-core 1.4Ghz CPU 1GB RAM, SFP+
              10Gbps cage and desktop case with rack ears
            </p>
            <p className="text-center font-bold">Rp. 3.500.000,00</p>
          </Card>{" "}
          <Card href="#" className="w-[303px] h-[404px] bg-transparent">
            <div>
              <img src="../../public/4011.png" alt="" sizes="6" srcset="" />
